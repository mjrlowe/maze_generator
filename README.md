...
| behavior | Cell selection method for `"growing tree"` algorithm. | Any of the following: `"newest"` (Recursive Backtracker), `"oldest"`, `"middle"`, `"random"` (Prim's) | `"newest"` (Recursive Backtracker) |
